...
def get_consumer_group(id_or_name: typing.Union[str, int], session: sqlalchemy.orm.Session) -> \
...
def get_municipal(id_or_name: typing.Union[str, int], session: sqlalchemy.orm.Session) -> \
        tables.Municipal:
    """
